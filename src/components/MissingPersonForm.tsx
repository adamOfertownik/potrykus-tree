    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true">
      <div className="modal-card modal-card--wide">
        <header className="modal-card__head">
          <h2>Nie ma Cię w drzewie?</h2>
          <p>
            Podaj swoje dane i bliskich (rodzice, rodzeństwo, dzieci) — dopasujemy
            gałąź.{" "}
            <strong>Prototyp:</strong> zgłoszenie nigdzie jeszcze nie trafia na
            trwałe.
          </p>
        </header>
        ...
        {done ? (
          <div className="modal-success">
            <p>Dzięki! Zapisaliśmy lokalnie na prototypie.</p>
            <p className="muted">
              Gdy podłączymy bazę, damy znać — wtedy zgłoszenia będą zbierane na
              serio.
            </p>
